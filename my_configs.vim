...
augroup fl_dart
  ...
  autocmd Syntax dart syntax keyword dartFlutterClasses
   ...
   \ ClipOval ClipPath ClipRect ClipRRect Color ColorFilter ColorSwatch ColorTween Colors
   ...
   \ TapDownDetails TapUpDetails Text TextBox TextDecoration TextField
